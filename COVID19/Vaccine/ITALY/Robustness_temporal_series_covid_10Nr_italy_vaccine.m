...
%load('mode_parameters_2step_LINLOG_Nr10_Ns100000_ITALY_I2I3DE_multivariate_1SET_2may.mat');
pN=ones(1,28);
...
for k=1:Nr
    ...
    %bounds for fraction FracSev
    LBpi_FracSev=0.01/pN(6);  
    UBpi_FracSev=0.08/pN(6);   
 
    %bounds for fraction FracCrit
    ...
    LBpi_FracCrit2=0.001/pN(21);   
    UBpi_FracCrit2=0.02/pN(21);
    
    %bounds for fraction FracCrit3
    LBpi_FracCrit3=0.001/pN(22);   
    UBpi_FracCrit3=0.02/pN(22);
    
    %bounds for fraction FracCrit4
    LBpi_FracCrit4=0.001/pN(23);   
    UBpi_FracCrit4=0.02/pN(23);
   
    %bounds for transmission rate be2
    LBpi_be2=0.01/pN(24);   
    UBpi_be2=1/pN(24);
    
    %bounds for transmission rate b02
    LBpi_b02=0.01/pN(25);   
    UBpi_b02=1/pN(25);      
  
    %bounds for probability of death of hospitalized patients
    LBpi_ProbDeathH=10/pN(26);   
    UBpi_ProbDeathH=90/pN(26);
    
    %bounds for n
    LBpi_nHILL=1/pN(27);   
    UBpi_nHILL=100/pN(27);
    
    %bounds for K
    LBpi_KHILL=1/pN(28);   
    UBpi_KHILL=10^5/pN(28);
    ...
    %Perturbation_be1=LBpi_be1+(UBpi_be1-LBpi_be1).*lhs;
    ...
    %Perturbation_b01=LBpi_b01+(UBpi_b01-LBpi_b01).*lhs;
    ...
    %Perturbation_s0_0=LBpi_s0_0+(UBpi_s0_0-LBpi_s0_0).*lhs;
    ...
    %perturbation array for FracCrit2
    ...
    %perturbation array for FracCrit3
    ...
    %perturbation array for FracCrit4
    ...
    %perturbation array for transmission rate be2
    ...
    %perturbation array for transmission rate b02
...
%         g3=(1/TimeICUDeath)-u;
        ...
        FracCritical2=piter(21);
        FracCritical3=piter(22);   
        FracCritical4=piter(23); 
        ...
        pNi = [be1 b01 b1 b2 b3 a0 a1 f g0 DurHosp FracSevere FracCritical DurMildInf ProbDeath TimeICUDeath FracCritical2 FracCritical3 FracCritical4 be2 b02 ProbDeathH n K tau_imm rho_firstdose rho_seconddose tau_first_second_dose]; 
        
        s0=[piter(16) piter(17) piter(18) piter(19) piter(20)];
        s1=1;
        s2=1;
        
        modelsim=@(t,x) ode_covid19_v3_vaccine_italy(t,x,pNi,Tlock,s0,s1,s2,region_name);
...
save ('sim_model_covid_Nr=10_Ns=100000_t=250_LINLOG_step1_ITALY_I2I3DE_1set_2MAY.mat','-v7.3');
